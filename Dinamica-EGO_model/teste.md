<h2 align="center">Dinamica EGO Models</h2>
    ...
    The scripts were consistently applied to all simulated regions. While input datasets and spatial constraints may vary by region, the modeling logic, transition structure, and simulation procedures remain the same.
