...
| SNCR/SIGEF | As duas bases vetoriais foram unidas possuindo o mesmo valor, então reclassificadas pelo tamanho da propriedade em 4 classes (minifúndio, pequena, média e grande propriedade). Os dados são rasterizados, reprojetados, redimensionados e em seguida alinhados com os outros. | [INCRA](https://www.gov.br/incra/pt-br) |
| CAR | A base vetorial foi separada em duas, sendo de APP e RL. Ambas foram recortadas somente as que estavam dentro da área de estudo. Em seguida, rasterizados, reprojetados, redimensionados e em seguida alinhados com os outros. | [SICAR](https://car.gov.br/#/) |
...
| Shortvegetation | Rasters adquiridos diretamente com os autores dos dados. Os dados foram recortados, reprojetados, redimensionados e alinhados com os demais rasters. | [LAPIG/GPW](https://www.researchsquare.com/article/rs-6521333/v1) |
